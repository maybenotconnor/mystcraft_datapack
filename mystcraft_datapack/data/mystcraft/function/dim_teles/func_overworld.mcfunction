# this is no longer relevant as this book has been removed
...
execute at @s[nbt={Dimension:"minecraft:the_nether"}] in minecraft:overworld run spreadplayers ~ ~ 0 16 false @s

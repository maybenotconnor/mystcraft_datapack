...
#Torn Book
execute as @e[type=item,nbt={Item:{id:"minecraft:shears",Count:1b}},limit=1,sort=nearest,distance=0..1] at @s run summon minecraft:item ~ ~0.1 ~ {Tags:["fresh_craft"],PickupDelay:50,Item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{display:{Name:'{"text":"Torn Book","italic":false,"color":"yellow"}',Lore:['{"text":"Random Teleport","italic":false,"obfuscated": true}']},HideFlags:6,Unbreakable:1b,CustomModelData:145353,tornbook:1b}}}